...
plt.subplot(3, 1, 1)
plt.plot(t, np.degrees(x[0]),'r', label='$\theta(t)$', linewidth=3)
plt.ylabel('$\\theta(t)$ [°]', fontsize=28)
#plt.xlim(0, tf)
#plt.legend()
#plt.ylim(20, 90)
plt.title('Levando o Sitema ao Ponto de Equilíbrio', fontsize=28)
plt.grid()
plt.subplot(3, 1, 2)
plt.plot(t, np.degrees(x[1]), 'b', label='$\omega(t)$', linewidth=3)
plt.ylabel('$\omega(t)$ [°/s]', fontsize=28)
#plt.legend()
#plt.xlim(0,tf)
plt.grid()
plt.subplot(3, 1, 3)
plt.plot(t, u, 'g', label='$u(t)$', linewidth=3)
...
plt.rcParams['ytick.labelsize'] = 20
plt.subplot(3, 1, 1)
plt.plot(td, np.degrees(xd[0]),'r', label='$\\theta(t)$', linewidth=3)
plt.ylabel('$\\theta(t)$ [°]', fontsize=28)
#plt.xlim(0, tf)
#plt.legend()
#plt.ylim(20, 90)
...
plt.grid()
plt.subplot(3, 1, 2)
plt.plot(td, np.degrees(xd[1]), 'b', label='$\omega(t)$', linewidth=3)
plt.ylabel('$\omega(t)$ [°/s]', fontsize=28)
#plt.legend()
#plt.xlim(0,tf)
plt.grid()
plt.subplot(3, 1, 3)
plt.plot(td, u, 'g', label='$u_d(t)$', linewidth=3)
plt.ylabel('$u_d(t)$', fontsize=28)
#plt.legend()
plt.xlabel('Tempo [s]', fontsize=28)
#plt.xlim(0,tf)
plt.grid()
...
plt.rcParams['xtick.labelsize'] = 20
plt.rcParams['ytick.labelsize'] = 20
plt.plot(t, np.degrees(x[0]),'b', label='$\\theta(t)$', linewidth=3)
...
plt.plot(td, np.degrees(xft)+50,'r--', label='FT', linewidth=3)
plt.ylabel('$\\theta(t)$ [°]', fontsize=28)
#plt.xlim(0, 5)
plt.legend(fontsize=18)
plt.xlabel('Tempo [s]', fontsize=28)
...
plt.plot(tv, (np.degrees(xvf)+50),'r--', label='FT', linewidth=3)
plt.ylabel('$\\theta(t)$ [°]', fontsize=28)
#plt.xlim(0, 5)
plt.legend(fontsize=18)
plt.xlabel('Tempo [s]', fontsize=28)
...
plt.rcParams['xtick.labelsize'] = 20
plt.rcParams['ytick.labelsize'] = 20
plt.plot(t, np.degrees(x[0]),color='r', label='$\\theta(t)$', linewidth=3)
